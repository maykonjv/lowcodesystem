            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <label for="javascript" class="form-label">SCRIPT da página (Front-End)</label>
                            <textarea id="javascript" name="javascript" class="form-control"  placeholder="Informe o javascript da página" rows="15"><%= ((Page) request.getAttribute("p")).getJavascript()%></textarea>
                        </div>
                    </div>
