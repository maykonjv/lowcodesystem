...
<script src="libs/vendors/Codemirror/lib/codemirror.js" type="text/javascript"></script>
<link href="libs/vendors/Codemirror/lib/codemirror.css" rel="stylesheet" type="text/css"/>
<link href="libs/vendors/Codemirror/theme/ayu-mirage.css" rel="stylesheet" type="text/css"/>
<style>
    .code-box{
        width: 100%;
        height: 100%;
...
<!-- MODES -->
<script src="libs/vendors/Codemirror/mode/javascript/javascript.js" type="text/javascript"></script>
<!-- ADDONS -->
<script src="libs/vendors/Codemirror/addon/selection/active-line.js" type="text/javascript"></script>
