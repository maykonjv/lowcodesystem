                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-9">
                            <label for="sqlExport" class="form-label">SQL de pesquisa para exportação de xlsx (gera planilha)</label>
                            <span title="Informe um sql válido para criar a planilha. Utilize alias para definir o nome das colunas. Para utilizar parametros de filtro, deverá copiar o id definido para o campo. Ex. WHERE [id=\#{id_campo_1}]. Todo bloco de sql entre [] será verificado se o parametro dentro dele possui valor, caso negativo esse bloco será excluído.">
