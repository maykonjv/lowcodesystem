...
<form   action="builder" method="post" id="modalSaveFormForm">
    <input type="hidden" name="session" value="form-sql-save"/>
    <input type="hidden" name="page" value="<%=((Page) request.getAttribute("p")).getId()%>"/>
    <input type="hidden" name="action" value="<%=request.getAttribute("action")%>"/>
    <div class="modal fade" id="modalSQLSave" data-coreui-backdrop="static" data-coreui-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-9">
                            <label for="sqlSave" class="form-label">SQL de inclusão do registro</label>
                            <span title="Informe um sql válido para inserir no banco os campos da tela.">
                            ...
                            <textarea id="sqlSave" name="sqlSave" class="form-control"  placeholder="Informe o sql para inserir um novo registro" rows="15"><%= ((Page) request.getAttribute("p")).getSqlSave()%></textarea>
                        </div>

                        <div class="mb-3 col-md-4">
                            <label for="sqlSaveDS" class="form-label">Datasource</label>
                            <select id="sqlSaveDS" name="sqlSaveDS" class="form-select" size="1">	
