...
<form   action="builder" method="post" id="modalViewFormForm">
    ...
    <div class="modal fade" id="modalSQLView" data-coreui-backdrop="static" data-coreui-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
