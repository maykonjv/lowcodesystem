                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="mb-3 col-md-3">
                            ...
                            <select multiple class="form-control" style="height: 375px;" ondblclick="$('#sqlActivate').val($('#sqlActivate').val() + $(this).val())">
                        ...
                        <div class="mb-3 col-md-9">
                            <label for="sqlActivate" class="form-label">SQL de Ativação/Inativação do registro</label>
                            <span title="Informe um sql válido para alterar o registro no banco.">
                            ...
                            <textarea id="sqlActivate" name="sqlActivate" class="form-control"  placeholder="Informe o sql para atualizar o registro" rows="15"><%= ((Page) request.getAttribute("p")).getSqlActivite()%></textarea>
                        </div>

                        <div class="mb-3 col-md-4">
                            <label for="sqlActivateDS" class="form-label">Datasource</label>
                            <select id="sqlActivateDS" name="sqlActivateDS" class="form-select" size="1">	
                                <% for (String key : DataSource.database.keySet()) {
                                        out.println("<option value=\"" + key + "\" " + (((Page) request.getAttribute("p")).getSqlActiviteDS().equals(key) ? "selected" : "") + ">" + key + "</option>");
                                    }%>
                            </select>
                        </div>
                    </div>
